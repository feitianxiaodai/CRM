...
namespace Crm.IServices
{
    ...
    public interface IBaseServices<TEntity> where TEntity:class
    {
        ...
        /// <param name="keySelector">要排序的lambda表达式</param>
        /// <returns></returns>
        List<TEntity> GetListByPage<TKey>(int pageindex, int pagesize, out int totalcount, Expression<Func<TEntity, bool>> where, Expression<Func<TEntity, TKey>> keySelector);
